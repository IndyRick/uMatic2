...
NexSlider mode_slider = NexSlider(3, 24, "mode_slider");
NexSlider PitchSlider = NexSlider(3, 3, "PitchSlider");
NexSlider VolSlider = NexSlider(3, 7, "VolSlider");
NexSlider T_Slider = NexSlider(3, 15, "T_Slider");
//NexSlider W_Slider = NexSlider(3, 14, "W_Slider");
NexSlider PTTSlider = NexSlider(3, 20, "PTTSlider");
NexButton resetKeyer = NexButton(3, 6, "resetKeyer");
NexButton resetI = NexButton(3, 23, "resetI");
...
NexNumber PTT = NexNumber(3, 19, "PTT");
