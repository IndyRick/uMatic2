...
#define NEX_RET_CMD_AUTO_SLEEP          (0x86) //30 MAY 2020   WW9JD Added Sleep Command Recognition
#define NEX_RET_CMD_AUTO_WAKE           (0x87) //30 MAY 2020 WW9JD Added Sleep Command Recognition
...
void nexLoop(NexTouch *nex_listen_list[])
{
    ...
    {   
	   ...
	   {
          dbSerialPrintln("recvRetCommand_Auto_Sleep");
	     NexTouch::iterate(nex_listen_list, 0x00, 0x02, 0x01);
	   }else{	
